...
module.exports = function( grunt ) {
	var paths = {
		js_files_concat: {
			'js/editor.js':                 ['js/src/admin/editor.js'],
			'js/google_maps_loader.js':     ['js/src/loader.js'],
			'js/google_maps_admin.js':      ['js/src/admin/google-maps.js'],
			'js/google_maps_user.js':       ['js/src/user/google-maps.js'],
			'js/widget_editor.js':          ['js/src/admin/widget-editor.js']
		},

		css_files_compile: {
			'css/google_maps_admin.css':   'css/sass/google_maps_admin.scss',
			'css/google_maps_user.css':    'css/sass/google_maps_user.scss'
		},

		plugin_dir: 'wordpress-google-maps'
	};
